(ns companion-valet.advisor
  "CompanionAdvisor — proposes a companion/valet operation (assist
  step, log entry, lifting/transfer assist, medication reminder) for
  a registered client. The advisor is swappable: `mock-advisor`
  ...
  of client provenance or lifting/medication risk;
  `companion-valet.governor` is the independent system that decides
  whether the proposal may proceed, per the itonami actor pattern.

  A proposal is a map:
    {:op :assist|:log|:lifting-transfer-assist|:medication-reminder
...
(def ^:private system-prompt
  "You are a companion/valet advisor. Given an assist or log
